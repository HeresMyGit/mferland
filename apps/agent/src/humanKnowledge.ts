...
export function getGameAgentHandbook() {
  return {
    ...
    worldMap: [
      ...
      { place: "fish monger", x: FISHING_ZONE.x + 4.6, z: FISHING_ZONE.z - 17, npcId: FISHING_VENDOR_NPC_ID, note: "fish buyer at the south-side market station; unlock fish sales by completing lost-fishing-shoes after the Motherfisher lesson" },
      { place: "pond ledger", x: FISHING_ZONE.x + 13.6, z: FISHING_ZONE.z - 1.6, npcId: FISHING_POND_STATUS_NPC_ID, note: "notice-board NPC that privately reports today's onchain-goodie claimed count, remaining claim slots, global cap state, and reset time" },
      { place: "onchain goodies", x: FISHING_ZONE.x + 21.7, z: FISHING_ZONE.z - 7.7, npcId: MINT_CLUB_REDEMPTION_NPC_ID, note: "pond-side redemption station for eligible Mint Club onchain goodies after the wallet claims them" },
