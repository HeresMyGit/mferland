...
function makePlayer(overrides: Partial<PlayerSnapshot> = {}): PlayerSnapshot {
  ...
  return {
    ...
    agentCommandStatus: "",
    agentCommandBudgetTier: "",
    agentCommandStartedAt: 0,
    agentCommandMaxSeconds: 0,
    agentCommandSessionUsedSeconds: 0,
    agentCommandSessionRemainingSeconds: 0,
    agentCommandDailyUsedSeconds: 0,
    agentCommandDailyRemainingSeconds: 0,
    agentCommandDailySeconds: 0,
    avatarSeed: 1,
    appearanceTraits,
    level: 1,
    xp: 0,
