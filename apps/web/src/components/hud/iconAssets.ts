...
const ITEM_ICON_SOURCES = {
  ...
  "green-fin-mferfish": `${ICON_ROOT}/items/green-fin-mferfish.png`,
  "based-bass": `${ICON_ROOT}/items/based-bass.png`,
  "pipe-whisker-catfish": `${ICON_ROOT}/items/pipe-whisker-catfish.png`,
  "spikeball-puffer": `${ICON_ROOT}/items/spikeball-puffer.png`,
  "top-hat-ape-crab": `${ICON_ROOT}/items/top-hat-ape-crab.png`,
  "huge-sartoshi-koi": `${ICON_ROOT}/items/huge-sartoshi-koi.png`,
  "gold-drip-goldfish": `${ICON_ROOT}/items/gold-drip-goldfish.png`,
  "orange-pipe-seahorse": `${ICON_ROOT}/items/orange-pipe-seahorse.png`,
  "messy-red-lobster": `${ICON_ROOT}/items/messy-red-lobster.png`,
  "zombie-angler": `${ICON_ROOT}/items/zombie-angler.png`,
  sartofish: `${ICON_ROOT}/items/sartofish.png`,
