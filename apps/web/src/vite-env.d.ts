...
interface ImportMetaEnv {
  ...
  readonly VITE_MFERLAND_BASE_SEPOLIA_RPC_URL?: string;
  readonly VITE_MFERLAND_DEBUG_WALLET_ADDRESS?: string;
  readonly VITE_MFERLAND_DEBUG_WALLET_PRIVATE_KEY?: string;
