...
export function buildAgentCatalog() {
  return {
    ...
    controls: {
      ...
      combat: ["combatAction"],
      lootAndItems: ["lootCorpse", "equipItem", "unequipItem", "useItem", "sellTrashItems", "startFishing", "reelFishing", "cancelFishing", "submitFishingNftClaimTx", "submitMintClubRedemptionTx", "sellFishingItems", "purchaseFishingSupply"],
    ...
    menus: {
      ...
      fishing: {
        ...
        observes: ["self.fishingState", "self.fishingBobber", "self.fishing.nftPond", "lootWindow.source=fishing", "inventory.fishing", "activeBuffs", "fishingResult", "fishingNftCatchResult", "fishingNftHistoryResult", "mintClubRedemptionResult", "fishingSupplyPurchaseResult", "fishingVendorSellResult", "season0Points", "season0DailyPoints"],
        controls: ["startFishing", "reelFishing", "lootCorpse", "cancelFishing", "submitFishingNftClaimTx", "submitMintClubRedemptionTx", "purchaseFishingSupply", "sellFishingItems"],
        paidControlRequiresPaymentProof: true,
        note: `Fish through normal room messages. Cast near ${FISHING_ZONE.name}, wait for the bite state, then reel. Catches open a fishing lootWindow; collect it with lootCorpse using that lootWindow npcId/source id. Motherfisher sells bucket of old chum after fishin-lesson with an MFERGPT burn proof. Fish sales happen at fish monger after lost-fishing-shoes; Mint Club onchain goodies are wallet actions at ${MINT_CLUB_REDEMPTION_NPC_ID}.`,
      },
      hotbar: {
    ...
    fishing: {
      ...
      playbook: [
        ...
        "If reelFishing returns nft, external wallet tooling must sign FishingPond.claim and then send submitFishingNftClaimTx with the tx hash.",
