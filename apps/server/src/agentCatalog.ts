...
export function buildAgentCatalog() {
  return {
    ...
    controls: {
      ...
      combat: ["combatAction"],
      lootAndItems: ["lootCorpse", "equipItem", "unequipItem", "useItem", "sellTrashItems", "startFishing", "reelFishing", "cancelFishing", "submitFishingNftClaimTx", "sellFishingItems", "purchaseFishingSupply"],
    ...
    menus: {
      ...
      fishing: {
        ...
        observes: ["self.fishingState", "self.fishingBobber", "self.fishing.nftPond", "lootWindow.source=fishing", "inventory.fishing", "activeBuffs", "fishingResult", "fishingNftCatchResult", "fishingSupplyPurchaseResult", "fishingVendorSellResult", "season0Points", "season0DailyPoints"],
        controls: ["startFishing", "reelFishing", "lootCorpse", "cancelFishing", "submitFishingNftClaimTx", "purchaseFishingSupply", "sellFishingItems"],
