  ...
  return {
    ...
    menus: {
      ...
      fishing: {
        ...
        controls: ["startFishing", "reelFishing", "lootCorpse", "cancelFishing", "submitFishingNftClaimTx", "abandonFishingNftCatch", "prepareMintClubRedemption", "cancelMintClubRedemptionPreparation", "submitMintClubRedemptionTx", "refreshFishingNftHistory", "purchaseFishingSupply", "purchaseOnchainFishingRod", "sellFishingItems"],
    ...
    fishing: {
      ...
      controls: {
        ...
        prepareMintClubRedemption: { message: "prepareMintClubRedemption", shape: { catchId: "confirmed pond catch id", requestId: "unique private request id" } },
        cancelMintClubRedemptionPreparation: { message: "cancelMintClubRedemptionPreparation", shape: { catchId: "confirmed pond catch id", requestId: "same private preparation request id; only after explicit wallet rejection before broadcast" } },
        submitMintClubRedemptionTx: { message: "submitMintClubRedemptionTx", shape: { catchId: "confirmed pond catch id", txHash: "player-signed Mint Club Bond.burn tx hash", status: "confirmed after wallet receipt", requestId: "unique private request id" } },
      },
      ...
      playbook: [
        ...
        "If a confirmed pond NFT has mintClubRedemption, reserve it once with prepareMintClubRedemption immediately before the wallet sell, then send submitMintClubRedemptionTx with the same catch and the real burn hash. Headless agents should use /agent-fishing prepare_redemption, which performs the same reservation before returning sell calldata.",
