...
export function spawnNpcs(npcs: MapSchema<NpcState>) {
  const specs: NpcSpawnSpec[] = [
    ...
    },
    {
      ...
      yaw: 0,
      leashRadius: 1.2,
      dialogue: "talent regrets? burn the receipt, get the points back.",
    },
    {
      id: "gate-guard",
      name: "gate mfer",
    ...
    },
    {
      ...
      yaw: -0.71,
      leashRadius: 1.2,
      dialogue: "lesson first, chum after. pond's got fish, bad smells, and no committee, mfer.",
    ...
    },
    {
      ...
      yaw: -0.94,
      leashRadius: 1.2,
      dialogue: "i buy fish after my lucky fishing shoes come home. do not ask why they are lucky.",
    ...
    },
    {
      ...
      yaw: -1.18,
      leashRadius: 1.2,
      dialogue: "caught a redeemable onchain goodie? i can point your wallet at the burn button.",
    },
    {
      ...
      yaw: -1.82,
      leashRadius: 1.2,
      dialogue: "i count onchain goodies so you don't have to.",
    },
    {
      id: "ridge-guide-mfer",
