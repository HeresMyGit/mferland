...
- Use the shared merchant id helpers for merchant affordances. Current merchant mfers are `potion-mfer`, `crypto-mfer`, `traits-mfer`, `swap-mfer`, `trash-mfer`, and `respec-mfer`; drip/wearables is not a shop merchant.
