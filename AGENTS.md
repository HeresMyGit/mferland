...
- A local browser viewer is acceptable in the public skill package only as a passive loopback renderer of the runner's observed state and last decisions. It must not send gameplay messages or expose private wallet material.
