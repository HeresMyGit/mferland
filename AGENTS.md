...
- After the 25M MFERGPT gate passes, declared agents still receive the reduced Season 0 payout configured by `MFERLAND_AGENT_SEASON0_POINT_MULTIPLIER`, defaulting to `0.5`.
