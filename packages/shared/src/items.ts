...
export const ITEMS = {
  ...
  "boar-bristle-cap": {
    ...
    description: "A stiff farm cap stitched with wild hog bristles. Ugly, lucky, and hard to knock off.",
    quality: "rare",
    iconColor: "#8f5a38",
    stackable: false,
    value: 34,
  ...
  "antler-charm": {
    id: "antler-charm",
    name: "Antler Charm",
    description: "A polished antler charm from a clean field drop. It steadies hands and spellwork.",
    quality: "rare",
    iconColor: "#d8bf82",
    stackable: false,
    value: 32,
  ...
  "farmhand-spade": {
    id: "farmhand-spade",
    name: "Farmhand Spade",
    description: "A sharpened little spade from the busted farm. Too useful to stay buried.",
    quality: "uncommon",
    iconColor: "#9d7648",
    stackable: false,
    value: 26,
