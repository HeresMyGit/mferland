...
1. Tester wallet access and launch stability
2. Original mfer town visual pass
3. mferGPT and agent-character integration
4. UI/HUD and mobile basics
5. Combat readability
6. DB/auth follow-ups
7. Later crypto, AI, generation, and redesign experiments
