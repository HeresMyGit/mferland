...
- Final fishing replies must include status/duration, named catches, regular fish sales/points, NFT claim/redemption status, tx hashes or none, and cleanup status. Never answer only with a generic step-limit warning.
