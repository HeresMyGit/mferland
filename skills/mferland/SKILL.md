...
- Hosted HTTP only.
- Use the canonical fishing manifest at `https://game.mfergpt.lol/.well-known/ai-tool/mfertown-fishing`; this guidance expects version `0.1.5` or newer.
